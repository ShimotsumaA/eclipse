...
<body>
	<div style="text-align:center">
		...
		<table border="1" align="center">
			<th></th><th>お支払方法</th>
			<tr>
				<td><input type="radio" name="radio" id="siharai" value="hurikomi"></td>
				<td>銀行振込</td>
			</tr>

			<tr>
				<td><input type="radio" name="radio" id="siharai" value="credit_card"></td>
				<td>クレジットカード決済</td>
			</tr>

			<tr>
				<td><input type="radio"  name="radio" id="siharai" value="daibiki"></td>
				<td>代金引換</td>
			</table>
